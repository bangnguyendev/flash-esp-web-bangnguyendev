  ...
  public connectedCallback() {
    ...
    if (!InstallButton.isSupported || !InstallButton.isAllowed) {
      ...
      this.renderRoot.innerHTML = !InstallButton.isAllowed
        ? "<slot name='not-allowed'>⛔⛔⛔<br>You can only install ESP devices on HTTPS websites or on the localhost.</slot>"
        : "<slot name='unsupported'>⚠️⚠️⚠️<br>Your browser does not support installing things on ESP devices. Use Google Chrome or Microsoft Edge.</slot>";
      return;
    }
